...
namespace AspNetCoreIdentityApp.Web.Controllers
{
    ...
    public class MemberController : Controller
    {
        ...
        public async Task<IActionResult> UserEdit(UserEditViewModel request)
        {
            ...
            TempData["SuccessMessage"] = "Profiliniz başarıyla değiştirilmiştir.";
            return View(await _memberService.GetUserEditViewModelAsync(userName));
        }
        ...
        public IActionResult AccessDenied(string returnUrl)
        {
            ...
            message = "Bu sayfayı görüntüleme yetkisine sahip değilsiniz. Yetkilendirme için Admin ile görüşünüz.";
